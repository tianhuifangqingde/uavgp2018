...
int main(int argc, char **argv)
{
  ...
  wp.z_alt        = 4;
  wp.x_lat        = target1.x;//39.962715;
  wp.y_long       = target1.y;//116.304002;
  srv_wp.request.waypoints.push_back(wp);
  wp.param1       = 5;
  wp.z_alt        =2;
  wp.x_lat        = target1.x;//39.96271;
  wp.y_long       = target1.y;//116.304001;
  srv_wp.request.waypoints.push_back(wp);
  wp.z_alt        =4;
  wp.x_lat        = target1.x;//39.96271;
  wp.y_long       = target1.y;//116.304001;
  srv_wp.request.waypoints.push_back(wp);
  wp.z_alt        =4;
  wp.x_lat        = target2.x;//39.96271;
  wp.y_long       = target2.y;//116.304001;
  srv_wp.request.waypoints.push_back(wp);
  wp.command      = mavros_msgs::CommandCode::NAV_LAND;
  wp.z_alt        = 0;
  wp.x_lat        = 39.962769;
  wp.y_long       = 116.304855;
  srv_wp.request.waypoints.push_back(wp);
  //...
